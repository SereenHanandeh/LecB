...
CREATE TABLE IF NOT EXISTS plan_period_quotas (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS
idx_plan_period_quotas_plan
ON plan_period_quotas(plan_id);

CREATE INDEX IF NOT EXISTS
idx_plan_period_quotas_supervisor
ON plan_period_quotas(supervisor_id);
