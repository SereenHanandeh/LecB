...
//
// القاعدة:
// - نريد 10 مشرفين يوميًا
// - المشرف الذي عمل أمس لا يعمل اليوم
// - نحاول توزيع الأيام بالتساوي
//
// مثال 20 مشرف:
// Day 1 -> 1..10
// Day 2 -> 11..20
...
function buildDailyPools(
  ...
  days.forEach((day, dayIndex) => {
    ...
    // -----------------------------------------------
    // إذا كان العدد أقل من المطلوب
    //
    // هذا يحدث عندما يكون عدد المشرفين غير كافٍ
    // لتحقيق شرط عدم العمل يومين متتالين.
    // -----------------------------------------------
...
// =====================================================
//
// بعد التوزيع نحاول التأكد أن الفرق بين أعلى
// وأقل مشرف ليس كبيرًا.
//
// ملاحظة:
// لا ننقل تعيينات هنا بطريقة عشوائية حتى لا نكسر
// شروط الأيام والفترات.
//
